...
Мокапы (прототипы) интерфейса будут разработаны с помощью инструмента **Balsamiq Mockups** (или аналога) и выложены в репозиторий в папку `/mockups`. Эскизы включают:
...
*   Страницу просмотра и редактирования профиля пользователя.
*   Страницу создания/редактирования маршрута.
*   ![Alt text]("mockups/Create_Route.png")
*   Страницу просмотра и добавления мест (местоположений).
*   Модальные окна для быстрого добавления сущностей.

*(В данном документе представлены текстовые описания. Визуальные мокапы прилагаются отдельно)*
